        ...
        element.childNodes.forEach((childElement) => {
            ...
            if (overriddenElementProcessing) {
                ...
                if (/^h[1-6]$/i.test(elem.tagName)) {
                    ...
                    if (elem.href.startsWith("data:image")) {
                        ...
                        const href = options?.websiteDomain && elem.href.startsWith(options.websiteDomain) ?
                            elem.href.substring(options.websiteDomain.length) :
                            elem.href;
